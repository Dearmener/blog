...
`;
        ...
        let folder = (_a2 = fm == null ? void 0 : fm.folder) != null ? _a2 : this.settings.folder;
        ...
        try {
          ...
          if (!localUpload) {
            ...
            url = this.settings.imageUrlPath+"mengguoqing%2F" + key;
            console.log(url)
          } else {
            await this.app.vault.adapter.writeBinary(key, new Uint8Array(buf));
            url = this.app.vault.adapter instanceof import_obsidian.FileSystemAdapter ? this.app.vault.adapter.getFullPath(key) : key;
          }
